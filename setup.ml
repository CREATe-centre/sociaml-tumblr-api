...
(* OASIS_START *)
(* DO NOT EDIT (digest: bdf074d6d0519fb8067cc2e327c6bd09) *)
(*
...
let setup_t =
  {
     ...
     package =
       {
          ...
          homepage =
            Some "https://github.com/dominicjprice/sociaml-tumblr-api";
          synopsis = "Tumblr API Client Library for OCaml";
          description =
            Some
              [
                 OASISText.Para
                   "Access version 2 of the Tumblr API in OCaml applications."
              ];
          categories = [];
            ...
            [
               Library
                 ({
                  ...
                  },
                   {
                      ...
                      bs_build_depends =
                        [
                           ...
                           FindlibPackage
                             ("sociaml_oauth_client.v1_0a", None);
                           FindlibPackage ("tiny_json", None);
                           FindlibPackage ("tiny_json_conv", None);
                   ...
                   {
                      lib_modules =
                        ["Api"; "Auth"; "Csv_util"; "Json_util"; "Types"];
                      lib_pack = true;
                      lib_internal_modules = [];
                      lib_findlib_parent = None;
                      lib_findlib_name = Some "sociaml_tumblr_api";
               ...
               Doc
                 ({
                  ...
                  },
                   {
                      ...
                      doc_install_dir = "$htmldir/sociaml-tumblr-api";
                      doc_title = "sociaml-tumblr-api Reference";
                      doc_authors = ["Dominic Price"];
                      doc_abstract = None;
               ...
               SrcRepo
                 ({
                  ...
                  },
                   {
                      src_repo_type = Git;
                      src_repo_location =
                        "https://github.com/dominicjprice/sociaml-tumblr-api.git";
                      src_repo_browser =
                        Some
                          "https://github.com/dominicjprice/sociaml-tumblr-api";
     ...
     oasis_version = "0.4.5";
     oasis_digest = Some "\001\139n\133RXÜ¥[ØÍÏî/«L";
     oasis_exec = None;
     oasis_setup_args = [];
     setup_update = false
  };;
